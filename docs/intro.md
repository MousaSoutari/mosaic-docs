...
**26 specialized agents, 86+ workflows, and 133 skills** -- installed with a single command.
...
| **bmad-bmb** | 2 | 15 | BMAD builders -- create agents, workflows |
...
- **Skills** -- Slash commands that trigger workflows (e.g., `/bmad-create-prd`)
